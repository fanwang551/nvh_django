...
问题1：选择噪声数据测点时报错“Internal Server Error: /api/acoustic-analysis/steady-state/query/
...
”
问题2：选择转速测点数据或者振动数据时，前端过一会才会加载图像，前端显示“SteadyStateAnalysis.vue:175  [ECharts] Can't get DOM width or height. Please check dom.clientWidth and dom.clientHeight. They should not be 0.For example, you may need to call this in the callback of window.onload.
